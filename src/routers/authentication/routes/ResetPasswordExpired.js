...
// MAIN COMPONENT
const ResetPasswordExpired = compose(withRouter)(({ history }) => {
  ...
  return (
    <Page
      ...
      message={['Please request a new reset password link','Enter the username or email address associated with your account.']}
      back={{
