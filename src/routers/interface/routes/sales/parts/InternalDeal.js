...
const InternalDealForm = compose(withRouter)(() => {
    ...
    <Form.Body plaintext>
      ...
      {sale_type_name == 'Lease' && (
        <>
          ...
          <Form.Control plaintext label="Lease Warranty Reserve" name="lease_warranty_reserve" />
        </>
      )}
      ...
      <Form.Control label="Frontend Gross Before Pack" name="frontend_gross_bp" schema="dollars" />
      {sale_type_name === 'Lease' && (
        <>
      ...
      <Form.Control label="Frontend Gross After Pack" name="frontend_gross" schema="dollars" />
...
export default function InternalDeal(props) {
  return <Card title="Internal Deal Recap" body={<InternalDealForm {...props} />} />;
}
