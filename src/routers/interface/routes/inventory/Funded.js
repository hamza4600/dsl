...
const Funded = () => {
  ...
  return (
    <Main>
      <Title
        documentTitle="Inventory -> Funded "
        title="Funded"
        tools={[
          <Button.Link
            icon="print"
          ...
          >
            <DownloadButton
              ...
              filters={{ activecolumns: showColumns.toString(), inventoryType: 'F', ...filters }}
            />
          </Tooltip>
        ]}
      />
      <Filters>
        ...
        <Filters.Select.InventoryStatus
          lookupParams={{
            inventoryType: INVENTORY_TYPE.funded.code
          }}
        />
...
// EXPORT
export default getListData(Funded, {
  key: 'funded',
  fetchArgs: {
    endpoint: ENDPOINTS.inventory.list,
    params: {
